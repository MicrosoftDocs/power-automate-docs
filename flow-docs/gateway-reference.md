...
## Install a gateway
> [!IMPORTANT]
> Microsoft SharePoint data gateways support HTTP and HTTPS traffic.
> 
> 
...
6. Click or tap the option to register a new gateway or migrate, restore, or to take over an existing gateway, and then click or tap **Next**.
