In addition to being able to **get notifications** and **copy files**, **Power Automate** also enables you to **collect data**.  This can be useful for **analytics**, like with **Power BI**.  
