...
2. Browse to [Microsoft Flow](https://flow.powerapps.com), and add a custom API as described in [Register and use custom APIs in Microsoft Flow](register-custom-api.md).
