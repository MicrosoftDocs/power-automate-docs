...
> - Learn more about restoring a deleted desktop flow created by Power Automate for desktop at [Restore a deleted desktop flow](/power-automate/desktop-flows/how-to/reduce-flow-size).
