---
title: Get started with copilot-powered editing (preview)
description: Learn how to access and use copilot-powered editing.
ms.date: 05/23/2023
ms.custom: 
  - transparency-note
ms.topic: conceptual
...
# Get started with copilot-powered editing (preview)

[This article is prerelease documentation and is subject to change.]

Copilot-powered editing allows you to create automation that helps streamline your workflow through quick and easy natural language expressions. With copilot-powered editing, create a flow by describing what you need through multiple steps of conversation. Copilot-powered editing is always available.

Copilot-powered editing can perform the following actions:
...
- Answer questions about your flow and product. For example, you can ask copilot-powered editing questions about your flow like, *What does my flow do?* You can also ask copilot-powered editing product questions like, *How do I access child flows?* and *How do I access licenses?*
...
You need a Power Platform environment in the United States or Preview (United States) region for copilot-powered editing (preview).

> [!NOTE]
> If your environment is in the United States or Preview (United States) region and you still don’t see the copilot-powered editing experience, contact your admin. Ask if they've requested Microsoft Support to disable copilot-powered editing (preview).

## Create a flow using copilot-powered editing

Follow these steps to create a flow using copilot-powered editing.

1. Sign in to [Power Automate](https://make.powerautomate.com).
1. Start describing your automation scenario.

    As you're typing, copilot-powered editing shows you a list of AI generated suggested flow descriptions.

    Alternatively, you can select **Create** > **Describe it to design it (preview)**.

    :::image type="content" source="./media/get-started-with-copilot/copilot-home-example.png" alt-text="Screenshot of the 'Home' screen, where you can start building your flow with copilot-powered editing (preview).":::
...
1. To accept the flow that copilot-powered editing (preview) created for you, select **Next**.
...
1. To finalize your flow, configure the required settings, and then select **Create flow**.
    ...
    The copilot-powered editing (preview) designer opens with your flow.
...
1. On the panel to the right, follow the Copilot suggestions to complete the flow setup, or make edits to your flow using copilot-powered editing.
...
Writing good prompts includes more than just being specific with your request, or saying how you want your results to be displayed. With copilot-powered editing, you can try out different variations of prompts to help you evaluate what works best. If the initial results aren’t what you’re looking for, try tweaking your prompt and running it again.
...
### Examples of interactions with copilot-powered editing

This section describes some example scenarios of how you can interact with copilot-powered editing (preview).
...
## Edit a flow using copilot-powered editing

You can use copilot-powered editing to edit your existing flows. You don’t need to re-create a flow from scratch to take advantage of copilot-powered editing (preview).

1. Sign in to [Power Automate](https://make.powerautomate.com).
1. On the left panel, select **My flows**.
1. Find your flow, and then select the vertical ellipses (**&vellip;**).
1. Select **Try Copilot-powered editing (preview)**.
    ...
    Alternatively, access copilot-powered editing (preview) from the flow **Details** page of your existing flow by selecting the flow name from **My flows** > **Edit** > **Try Copilot-powered editing (preview)**.

    Your flow opens in the copilot-powered editing experience. You can now edit your flow using copilot-powered editing (previews).

## Frequently asked questions

Use this section to find answers to frequently asked questions.

### Why don’t I see copilot-powered editing (preview) in my Power Automate experience?
...
- Ask your admin if they've requested Microsoft Support to disable copilot-powered editing (preview).
...
### What are the limitations of copilot-powered editing during preview?

- You can’t edit flows with the copilot-powered editing experience if your flow has any of the following flows capabilities:
...
- You can’t use copilot-powered editing (preview) if you’re using a personal Microsoft account. For example, you can’t use someone@live.com. Use a work or school account like someone@contoso.com instead.
- Copilot-powered editing (preview) supports English language only for models.

### See also

- [Responsible AI FAQs for Power Automate](responsible-ai-overview.md)
- [FAQ for copilot-powered editing (preview)](faqs-copilot.md) 
