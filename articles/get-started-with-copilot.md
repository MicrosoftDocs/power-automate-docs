...
You can use Copilot to not just create a starting flow but to change or complete your existing flows. 
...
1. Find your flow, select the vertical ellipses (**&vellip;**), and then select **Edit**. 
    ...
    Alternatively, access the cloud flows designer with Copilot from the flow **Details** page of your existing flow by selecting the flow name from **My flows** > **Edit**.

    Your flow opens with copilot pane on the side. You can now edit your flow by using the cloud flows designer with Copilot. Try asking prompts such as:
   1. Delete action X
   2. I want to send an email at the end of the flow with subject equal to the SharePoint file name.
   3. Instead of email, I want to post message on Teams channel.
   4. Check if each of the Sharepoint item being returned have title equals 'USB' if so, send an email.
...
- Ask you admin if they've turned on copilot in your tenant/environment.
...
### What are the limitations of the cloud flows Copilot?

You can’t edit flows in the new cloud flows designer with Copilot experience if your flow has any of the following flows capabilities:
...
### There are some missing functionalities in Copilot powered new designer. What do I do? 

If you want to add missing functionalities in the new designer such as: SAP connector, hybrid triggers (For a selected X), a comment, Power Pages or PApps v1 trigger in your flow, the new designer does not yet support these constructs and will soon. Please switch to Classic Designer from within the new designer to be able to access the missing functionalities

<img width="1098" alt="image" src="https://github.com/MicrosoftDocs/power-automate-docs-pr/assets/91279975/00464f00-ce18-4dd8-9cac-4066e9d52537">
