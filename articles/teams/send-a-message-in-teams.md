...
1. Sign in to Power Automate, and then select **My flows** > **New** > **Automated cloud flow**.
1. Enter a name for your flow.
1. Select the **When a new file is created in a folder** trigger.
<<TODO: Update image>>
...
<<TODO image of the action needed here>>

<<TODO image of the message needed here>>
