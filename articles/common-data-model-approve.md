<properties
    pageTitle="Build an approval loop with the Common Data Service | Microsoft Flow"
...
1. In the box that contains **Search for more actions**, type **Common**, and then click or tap **Common Data Service - Get object**.
...
1. Under **Create an app from your data**, click or tap **Phone layout** in the **Common Data Service** tile.
