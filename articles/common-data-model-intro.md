...
1. You could use any template that performs a task in Dataverse that you want to automate. In this example, we select template that copies notes from Lead to Opportunity in Dataverse.
