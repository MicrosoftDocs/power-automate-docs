...
1. The **Export this solution** page appears on the right. Enter or select from the following options, and then select **Export**.  
    ...
    > [!NOTE]
    >  The export might take a few minutes depending on the size of your solution.

1. After the export finishes, you'll see a notification at the top with a link to download the solution zip file. Select **Download** from this notification on the top-right side of the screen to download the solution zip file.
