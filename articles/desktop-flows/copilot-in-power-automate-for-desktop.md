...
:::image type="content" source="media/pad-copilot/power-automate-desktop-copilot-designer-add-step.png" alt-text="A screenshot that shows the recorder placeholder":::
...
:::image type="content" source="media/pad-copilot/power-automate-desktop-copilot-designer-recorder_placeholder.png" alt-text="A screenshot that shows the recorder placeholder":::
