...
> [!NOTE]
> When filtering the retrieved results by modifying the **From contains** argument in the **Retrieve email messages from Outlook** action, use email addresses in plain display format (SMTP) as x.500 formatted ones are not recognized.
