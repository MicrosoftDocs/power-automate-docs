...
:::image type="content" source="media\scripting\powershell_action2.png" alt-text="Screenshot of the run PowerShell action with the prompt dialog open":::
...
:::image type="content" source="media\scripting\powershell_action3.png" alt-text="Screenshot of the run PowerShell action with the prompt dialog open":::
