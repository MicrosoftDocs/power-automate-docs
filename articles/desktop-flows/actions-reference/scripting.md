...
:::image type="content" source="media/nl2script/powershell_action.png" alt-text="Screenshot of the run PowerShell action with the Generate script with Copilot button highlighted":::

The create prompt screen will open, where you can type your natural language prompt:

:::image type="content" source="media/nl2script/powershell_action2.png" alt-text="Screenshot of the run PowerShell action with the prompt dialog open":::

To create a script, write your prompt and press the “Generate” button. If you need to recreate it, you can change the prompt and press the “Regenerate” button. Otherwise, press the “Use this script” button to go back to the main action window, where you can modify it and add any necessary variables. 

:::image type="content" source="media\nl2script/powershell_action3.png" alt-text="Screenshot of the run PowerShell action with the prompt dialog open":::
