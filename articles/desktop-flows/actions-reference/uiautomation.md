...
|Use regular expressions|N/A|[Boolean value](../variable-data-types.md#boolean-value)|False|Specify whether each value in the option name to interpret as a regular expression|
