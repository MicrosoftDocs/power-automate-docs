...
> [!NOTE]
> Please note that due to the 64-bit architecture of Power Automate Desktop, only installed 64-bit drivers are available for selection in the **Open SQL connection** action.
