...
> - Starting from version 2.55 of Power Automate for desktop, if a message appears indicating that the user doesn't have sufficient permissions in an environment, **Read** access must be provided to their respective security role on the **Tag** and **Tagged Process** table in Dataverse.
