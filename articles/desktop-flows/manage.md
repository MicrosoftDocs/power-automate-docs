...
> - Starting from v2.46 of Power Automate for desktop, where a message may appear indicating that the user doesn't have sufficient permissions in an environment using schema V2, **Read** access is required to be provided to their respective security role on the **Solution** entity in Dataverse.
