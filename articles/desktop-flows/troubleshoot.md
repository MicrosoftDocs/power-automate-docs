...
By default, Power Automate for desktop uses a Microsoft Edge client to facilitate user authentication. If you encounter errors while signing in, try setting it to authenticate users through WAM.
