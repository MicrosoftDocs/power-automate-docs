...
Starting in October 2023, v2 schema will be automatically enabled for all environments. Although not recommended, an additional toggle to opt-out of the auto-enablement is available in the Power Platform admin center, but is not recommended.
