...
- The URL can also be a Base64 encoded image. You can use a tool or website online that encodes images to Base64. Or use the Base64 text that a previous **Convert file to Base64** action or another trusted local encoder generates.
