...
This article lists the premium robotic process automation (RPA) features and benefits that are included in the Power Automate Premium plan and are available to [organization premium accounts](getting-started-org.md).
...
> [!IMPORTANT]
>
> - Unattended desktop flow executions require the Power Automate Process add-on, which can be applied against a qualifying base license.
> - AI Builder is licensed as an add-on for existing subscription plans. A certain number of AI Builder credits are included in the Power Automate Premium plan.
