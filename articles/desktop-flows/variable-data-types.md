...
- **Text value** - Any kind of text, from email addresses to the text contents of a .txt file. 
  ...
  [Text data type properties](https://review.docs.microsoft.com/en-us/power-automate/desktop-flows/datatype-properties#texts)
...
- **Numeric value** - This is the type applied to numbers. Only this data type can be used in mathematical operations. 
  ...
  Except for hardcoded numeric values, you can use mathematical expressions with variables within percentage signs. You can find more information about the mathematical expressions in the [Use variables and the % notation](https://review.docs.microsoft.com/en-us/power-automate/desktop-flows/variable-manipulation) article.
...
- **List** - Lists are collections of items. Depending on the types of the individual list items, there can be lists of text values, lists of numerical values, and so on. The list data type is the equivalent of a single-dimension array in programming terms. 
  ...
  [List data type properties](https://review.docs.microsoft.com/en-us/power-automate/desktop-flows/datatype-properties#lists)

- **Datarow** - A data row contains the values of a single row of a datatable. 

  [Datarow data type properties](https://review.docs.microsoft.com/en-us/power-automate/desktop-flows/datatype-properties#datarows) 
...
- **Datatable** - A datatable contains data in a tabular form. Datatables are the equivalent of two-dimensional arrays in programming terms. 
  ...
  [Datatable data type properties](https://review.docs.microsoft.com/en-us/power-automate/desktop-flows/datatype-properties#datatables) 
...
- **Web browser instance** – Contains a browser instance created through the **Launch new Internet Explorer** or other browser launching actions. 
  ...
  [Web browser instance data type properties](https://review.docs.microsoft.com/en-us/power-automate/desktop-flows/datatype-properties#web-browser-instances)

- **Window instance** – Contains a window instance created through the **Get window** action.

  [Window instance data type properties](https://review.docs.microsoft.com/en-us/power-automate/desktop-flows/datatype-properties#window-instance) 

- **Excel instance** – Contains an Excel instance created through the **Launch Excel** action.

  [Excel instance data type properties](https://review.docs.microsoft.com/en-us/power-automate/desktop-flows/datatype-properties#excel-instance) 
...
- **SQL connection** - Contains a connection to an SQL database established through the **Open SQL connection** action.
  ...
  [SQL connection data type properties](https://review.docs.microsoft.com/en-us/power-automate/desktop-flows/datatype-properties#sql-connection)
...
- **Exchange connection** - Contains a connection to an Exchange server established through the **Connect to Exchange server** action.
  ...
  [Exchange connection data type properties](https://review.docs.microsoft.com/en-us/power-automate/desktop-flows/datatype-properties#exchange-connection)

- **FTP connection** - Contains an FTP connection created through the **Open FTP connection** and **Open secure FTP connection** actions.

  [FTP connection data type properties](https://review.docs.microsoft.com/en-us/power-automate/desktop-flows/datatype-properties#ftp-connection) 
...
[Active Directory data type properties](https://review.docs.microsoft.com/en-us/power-automate/desktop-flows/datatype-properties#active-directory-entry)
...
[AWS data type properties](https://review.docs.microsoft.com/en-us/power-automate/desktop-flows/datatype-properties#ebs-snapshot) 
...
[Azure data type properties](https://review.docs.microsoft.com/en-us/power-automate/desktop-flows/datatype-properties#azure-managed-disk) 

### CMD

- **CMD session** - Contains a CMD session created through the **Open CMD session** action.

[CMD data type properties](https://review.docs.microsoft.com/en-us/power-automate/desktop-flows/datatype-properties#cmd-session)
...
[Dates and time data type properties](https://review.docs.microsoft.com/en-us/power-automate/desktop-flows/datatype-properties#dates)

### Email

- **Mail message** - Represents an email message. The **Retrieve emails** action populates these variables.

[Email data type properties](https://review.docs.microsoft.com/en-us/power-automate/desktop-flows/datatype-properties#mail-messages)
...
[Exchange data type properties](https://review.docs.microsoft.com/en-us/power-automate/desktop-flows/datatype-properties#exchange-mail-messages)
...
[Files and folders data type properties](https://review.docs.microsoft.com/en-us/power-automate/desktop-flows/datatype-properties#files)
...
[FTP data type properties](https://review.docs.microsoft.com/en-us/power-automate/desktop-flows/datatype-properties#ftp-files)
...
[Outlook data type properties](https://review.docs.microsoft.com/en-us/power-automate/desktop-flows/datatype-properties#outlook-mail-messages) 

### Terminal

- **Terminal session** - Contains a terminal session created through the **Open terminal session** action.

[Terminal data type properties](https://review.docs.microsoft.com/en-us/power-automate/desktop-flows/datatype-properties#terminal-session) 

### XML 
- **XML node** - Contains the content of an XML document. The **Read XML from file** action populates these variables.

[XML data type properties.](https://review.docs.microsoft.com/en-us/power-automate/desktop-flows/datatype-properties#xml-node) 