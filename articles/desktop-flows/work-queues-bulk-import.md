...
17. In the Column setting section set the following mapping:
...
18. Select **Next** and then **Publish**.
19. Navigate to the [Power Apps maker portal](https://make.powerapps.com) and select Dataflows from the left-menu (you might have to select **More** first to get to the Dataflows menu).
