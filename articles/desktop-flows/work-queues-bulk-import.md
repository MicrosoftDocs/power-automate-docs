...
## Comprehensive bulk-import platform options
...
This tutorial showcases both [Dataverse bulk-import options](/power-apps/maker/data-platform/data-platform-import-export) for importing a work queue along with its associated work queue items, which in this example is vendor invoices.
...
1. Save the file.
2. Create another file called **vendor-invoice-items.csv** and paste the following rows into it:

    ```json
    InvoiceId,InvoiceDate,AccountName,ContactEmail, Amount ,Status,WorkQueueKey
    I-1001,01/04/2023,Fabrikam,invoicing@fabrikam.com,4,232.16,Paid,Vendor Invoices
    I-1002,02/04/2023,Litware Inc.,adixon@litware.com,2,455.00,Paid,Vendor Invoices
    I-1003,03/04/2023,Proseware Inc.,lrobbins@proseware.com,7,458.98,Paid,Vendor Invoices
    I-1004,04/04/2023,Tailspin Toys,p.gupta@tailspintoys.com,5,237.26,Paid,Vendor Invoices
    I-1005,05/04/2023,WingTip Toys,b.friday@wingtiptoys.com,2,230.99,Invoiced,Vendor Invoices
    I-1006,06/04/2023,Fabrikam,invoicing@fabrikam.com,1,253.78,Paid,Vendor Invoices
    I-1007,07/04/2023,Proseware Inc.,lrobbins@proseware.com,3,345.87,Paid,Vendor Invoices
    I-1008,08/04/2023,Tailspin Toys,p.gupta@tailspintoys.com, $967.45 ,Paid,Vendor Invoices
    I-1009,09/04/2023,WingTip Toys,b.friday@wingtiptoys.com,1,437.75,Paid,Vendor Invoices
    I-1010,10/04/2023,Fabrikam,invoicing@fabrikam.com,1,687.43,Paid,Vendor Invoices
    I-1011,11/04/2023,WingTip Toys,b.friday@wingtiptoys.com,2,854.67,Paid,Vendor Invoices
    I-1012,12/04/2023,Litware Inc.,adixon@litware.com,6,743.12,Invoiced,Vendor Invoices
    I-1013,13/04/2023,Fabrikam,invoicing@fabrikam.com,2,997.12,Invoiced,Vendor Invoices
    I-1014,14/04/2023,Proseware Inc.,lrobbins@proseware.com, $843.76 ,Invoiced,Vendor Invoices
    I-1015,15/04/2023,Fabrikam,invoicing@fabrikam.com,1,349.24,Invoiced,Vendor Invoices
    I-1016,16/04/2023,Tailspin Toys,p.gupta@tailspintoys.com, $367.13 ,Invoiced,Vendor Invoices
    I-1017,17/04/2023,Litware Inc.,adixon@litware.com,3,984.54,Invoiced,Vendor Invoices
    I-1018,18/04/2023,Fabrikam,invoicing@fabrikam.com,1,943.89,Uninvoiced,Vendor Invoices
    I-1019,19/04/2023,Proseware Inc.,lrobbins@proseware.com,2,853.39,Paid,Vendor Invoices
    I-1020,20/04/2023,Fabrikam,invoicing@fabrikam.com,8,764.14,Paid,Vendor Invoices
    I-1021,21/04/2023,Litware Inc.,adixon@litware.com, $643.68 ,Paid,Vendor Invoices
    I-1022,22/04/2023,Proseware Inc.,lrobbins@proseware.com,4,232.16,Invoiced,Vendor Invoices
    I-1023,23/04/2023,Tailspin Toys,p.gupta@tailspintoys.com,3,345.87,Invoiced,Vendor Invoices
    I-1024,24/04/2023,WingTip Toys,b.friday@wingtiptoys.com,3,345.87,Invoiced,Vendor Invoices
    I-1025,25/04/2023,Fabrikam,invoicing@fabrikam.com,3,345.87,Invoiced,Vendor Invoices
    I-1026,26/04/2023,Proseware Inc.,lrobbins@proseware.com,6,743.12,Invoiced,Vendor Invoices
    I-1027,27/04/2023,Tailspin Toys,p.gupta@tailspintoys.com,4,232.16,Invoiced,Vendor Invoices
    I-1028,28/04/2023,WingTip Toys,b.friday@wingtiptoys.com,6,743.12,Invoiced,Vendor Invoices
    I-1029,29/04/2023,Fabrikam,invoicing@fabrikam.com,4,232.16,Invoiced,Vendor Invoices
    I-1030,30/04/2023,WingTip Toys,b.friday@wingtiptoys.com,3,345.87,Invoiced,Vendor Invoices
    ```
...
5. In the toolbar, select **Import** and then **Import data from Excel**.
    :::image type="content" source="media/work-queues/work-queue-import-csv.png" alt-text="Screenshot of the Dataflows list showing dataflows that are complete and still refreshing." lightbox="media/work-queues/work-queue-import-csv.png":::
6. Select **Upload** and choose the **vendor-invoice-queue.csv** file.
    :::image type="content" source="media/work-queues/work-queue-import-csv-confirm.png" alt-text="Screenshot of the Dataflows list showing dataflows that are complete and still refreshing." lightbox="media/work-queues/work-queue-import-csv-confirm.png":::
7. Confirm that the automapping was successful, or if needed adjust it by selecting **Map columns**.
    :::image type="content" source="media/work-queues/work-queue-import-csv-mapping.png" alt-text="Screenshot of the Dataflows list showing dataflows that are complete and still refreshing." lightbox="media/work-queues/work-queue-import-csv-mapping.png":::
8. Select **Import**.
...
10. Once complete, navigate to the work queue list page and confirm that vendor invoice queue has been added.
    :::image type="content" source="media/work-queues/work-queue-list-page.png" alt-text="Screenshot of the Dataflows list showing dataflows that are complete and still refreshing." lightbox="media/work-queues/work-queue-list-page.png":::

### Import work queue items

1. Next, navigate to <https://make.powerapps.com> and sign-in with your credentials.
2. Confirm that you're still in the correct environment and select **Tables** in the side-menu.
3. Select the **All** tab.In the toolbar select **Import** and then **Import data**.
4. Search for **Work Queue Item** table and open its details page.
5. In the **Power Query** dialog that opens, select the **Text/CSV** option.
...
6. Next, select **Upload file (Preview)** and then **Browse...** for the **vendor-invoice-items.csv** file.
...
7. If needed, establish a connection to your OneDrive for Business folder.
...
8. Select **Next** and confirm that you see the work queue item records and that **Comma** is selected as delimiter.
    :::image type="content" source="media/work-queues/work-queue-import-workqueue-file-preview.png" alt-text="Screenshot of Power Query dialog with a preview of the vendor invoice work queue data." lightbox="media/work-queues/work-queue-import-workqueue-file-preview.png":::
9. Select **Next**.
    > [!NOTE]
    >
...
10. In the Power Query transformation window, select the **Add column** tab on the ribbon toolbar and then select **Custom column**.
    :::image type="content" source="media/work-queues/work-queue-powerquery-transformation.png" alt-text="Screenshot of Power Query dialog with a preview of the vendor invoice work queue data." lightbox="media/work-queues/work-queue-powerquery-transformation.png":::
11. In the Custom column dialog box, enter **Input** as the new column name and ```Text.FromBinary(Json.FromValue(_))``` in the custom column formula field.
    :::image type="content" source="media/work-queues/work-queue-powerquery-formula.png" alt-text="Screenshot of Power Query dialog with a preview of the vendor invoice work queue data." lightbox="media/work-queues/work-queue-powerquery-formula.png":::
...
3. Navigate to <https://make.powerapps.com> and select Dataflows from the left-menu (you might have to select **More** first to get to the Dataflows menu).
4. Confirm that you see a new dataflow entry and that both icons show green once the import is complete.
...
5. Once complete, navigate to the work queue details page of the vendor invoice queue and confirm that the work queue items have been added.
