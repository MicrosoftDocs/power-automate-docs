...
If the **inputArguments** parameter contains all the input variables of the flow, then Power Automate console does not ask for user input during the flow run.
...
> [!IMPORTANT]
> All special characters in the JSON string should be escaped. For example, all double quotes should be backslash-escaped.
