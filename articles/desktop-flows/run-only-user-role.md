...
- Users don't gain environment-wide visibility into desktop flows they don't own or that aren't shared with them.
...
- Cloud flow permissions and roles aren't affected.
