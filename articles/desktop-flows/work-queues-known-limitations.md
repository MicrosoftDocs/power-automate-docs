...
| Dataverse limits | Work queues are based on Dataverse technologies, hence the same service protection and API limits etc. apply. [Learn more](/powerapps/developer/data-platform/api-limits-overview.md). |
