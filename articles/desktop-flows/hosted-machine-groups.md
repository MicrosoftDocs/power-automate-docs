...
Use your existing **Power Automate Premium plan with attended RPA** or **Power Automate Process plan** and the **Power Automate hosted RPA add-on**.
...
- Use the **Power Automate Premium plan** and the **Power Automate hosted RPA add-on trials**.
