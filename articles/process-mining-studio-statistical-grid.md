---
title: Use statistical grids in the process intelligence experience
...
## Configure a statistical grid

To configure a statistical grid, select the settings icon on the card to open the customization panel.
