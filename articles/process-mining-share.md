...
> [!IMPORTANT]
>
>- If a user is an admin in an environment, they already have access to all the processes. Therefore, if that user is added as a Co-owner or a Viewer they will not show up in the list of co-owners or viewers even if they are successfully assigned either of those roles.
>
