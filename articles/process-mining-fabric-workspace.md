...
1. Select **New item** in the top left corner.
1. In the right panel search or select **Lakehouse**.
...
1. Lakehouse is automatically created with a default semantic model and a SQL analytics endpoint. After the process is ingested and analyzed, a new semantic model is created. The default semantic model is not used by Power Automate Process Mining.
...
1. Select **Process mining** from the left navigation and click **Start here** in the **Create new process** section.
1. Fill in the process name and select the ingestion type (location of your data).
1. Select **Continue**.
1. Select **Your Fabric workspace** and then select **Continue**.
1. Select your *Fabric workspace* and *Fabric Lakehouse* from the lists and give the report a unique name in the required **Report name** field.
