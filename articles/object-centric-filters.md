---
title: Using Filters in OCPM Analysis (preview)
...
:::image type="content" source="media/object-centric-process-mining/object-centric-filter-toolbar.png" alt-text="Screenshot of the filter toolbar in Process Intelligence Studio for OCPM.":::
...
:::image type="content" source="media/object-centric-process-mining/object-centric-filter-object-type.png" alt-text="Screenshot of the OCPM object type filter configuration panel.":::
...
:::image type="content" source="media/object-centric-process-mining/object-centric-filter-object-proximity.png" alt-text="Screenshot of the OCPM object proximity filter configuration panel.":::
...
:::image type="content" source="media/object-centric-process-mining/object-centric-filter-object-attribute.png" alt-text="Screenshot of the OCPM object attribute filter configuration panel.":::
...
:::image type="content" source="media/object-centric-process-mining/object-centric-filter-timeframe.png" alt-text="Screenshot of the OCPM timeframe filter configuration panel.":::
