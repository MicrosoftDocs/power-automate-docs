...
- [Manage Power Automate Process plan (previously Power Automate per flow)](/power-platform/admin/power-automate-licensing/buy-licenses) capacity in [Power Platform admin center](https://aka.ms/ppac)
