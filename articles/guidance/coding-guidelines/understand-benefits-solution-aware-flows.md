...
:::image type="content" source="media/flow-connections.png" alt-text="Screenshot of flow connections on the Flow Details page.":::
...
:::image type="content" source="media/flow-connectionreference.png" alt-text="Screenshot of flow connection references on the Flow Details page.":::
...
:::image type="content" source="media/flow-versioning.png" alt-text="Screenshot of a cloud flow version history.":::
...
Note the following key differences when working with solutions in Power Automate:
...
The remainder of this section describes best practices when moving solutions and cloud flows across different environments.
...
- **Improved productivity**: By automating deployment processes, pipelines significantly enhance productivity for makers, developers, and admins. Solutions can therefore be delivered faster and with higher quality.
...
- **Service principal deployments**: Use service principals for deployments to maintain security and control to allow makers to request deployments without needing elevated access within target environments.

- **Integration with DevOps tools**: Enhance your continuous integration/continuous delivery (CI/CD) processes by integrating pipelines with tools like Azure DevOps and GitHub. This integration allows for seamless management and deployment of solutions.

- **Custom business logic**: Execute specific business logic by inserting custom steps into the pipeline progression, such as pre-export validation, pre-deployment checks, and other custom actions.
