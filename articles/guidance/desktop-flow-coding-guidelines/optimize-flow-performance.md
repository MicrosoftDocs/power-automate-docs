...
1. Application or file-specific Power Automate for desktop actions. For example, for Excel, PDF, and file/folder.
    ...
    :::image type="content" source="media/optimize-flow-performance/desktop-actions.png" alt-text="Screenshot showing various cloud connector Excel actions in Power Automate." lightbox="media/optimize-flow-performance/desktop-actions.png":::
...
Keep only the necessary flow components by deleting any disabled actions and removing unused UI elements and images. This practice decreases the size of the flow and reduces its saving and loading times.
...
- Use the **Data table** actions or **Database** actions for data table-related operations.
    ...
    :::image type="content" source="media/optimize-flow-performance/database.png" alt-text="Screenshot of a data table." lightbox="media/optimize-flow-performance/database.png":::
