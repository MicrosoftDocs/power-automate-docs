---
title: Use VBScript from the SAP GUI automation engine in desktop flows actions.| Microsoft Docs
...
# Use VBScript from the SAP GUI automation engine in desktop flows actions 
...
The good news is that you can use the VBScript that the SAP GUI automation engine generates in a Power Automate Desktop action. To use this VBScript, all you'd have to do is replace the manually entered text that’s captured during recording with dynamic inputs in Power Automate Desktop.
