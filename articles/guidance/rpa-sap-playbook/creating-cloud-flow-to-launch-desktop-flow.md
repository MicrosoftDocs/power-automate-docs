...
1. [Open Power Automate](https://make.powerautomate.com/), sign in, and confirm that you're in the same Microsoft Dataverse environment as the one you were in when you created the previous flow in Power Automate Desktop.
