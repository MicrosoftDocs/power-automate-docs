...
- **Datavers**: A set of custom tables that allow workflows to be defined and monitored
...
- **Consuming Apps/Flows**: Power Platform solutions can create a connection refernce to the Approvals Kit connector to begin a business approval workflow.
