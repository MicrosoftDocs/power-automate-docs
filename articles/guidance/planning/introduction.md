...
service you can use with<!--note from editor: To be consistent in these articles, I've followed the pattern of saying you can automate processes and tasks within applications and services, rather than automating the apps and services themselves.--> cloud services, desktop applications, and legacy
systems.
...
4.  [**Test**](testing-strategy.md): Try out the automation you created.<!--note from editor: Suggested. -->
