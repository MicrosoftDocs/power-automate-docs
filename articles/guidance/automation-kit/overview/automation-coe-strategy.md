...
The dotted blue boxes indicate the maturity model areas that the Automation Kit addresses using the [Holistic enterprise automation techniques (HEAT)](https://docs.microsoft.com/power-platform/guidance/automation-coe/heat). Dotted green boxes indicate areas address by the ALM Accelerator.
