<properties
    pageTitle="Understand on-premises data gateways | Microsoft Flow"
...
1. Accept the terms of use and the privacy statement.
...
1. On the **On-premises data gateway** screen, enter the email address for the account you will use to sign into the gateway, select **Sign in**, and then complete the sign in process.
