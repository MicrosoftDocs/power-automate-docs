...
Calls made from connectors in cloud flows come from [these IP addresses](/connectors/common/outbound-ip-addresses). Add them to your network's allow list to facilitate communications from Power Automate.
