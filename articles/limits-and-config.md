...
A flow's *performance profile* determines its Power Platform request limits. The following table describes the plans that are associated with each of the four performance profiles. [Learn more about how Power Automate consumes Power Platform requests] 
(https://learn.microsoft.com/en-us/power-platform/admin/power-automate-licensing/types#power-platform-requests)
...
Users can determine which plan they have by pressing clicking on settings on the Power Automate title bar and going to view licenses 
![image](https://github.com/MicrosoftDocs/power-automate-docs-pr/assets/62711514/df8b4b84-b194-42d2-84c5-20dcabeec0ad)
