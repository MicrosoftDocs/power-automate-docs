...
| Not triggered (dormant) flows | 90 days for Free, Trial and Microsoft 365 Plans, no expiration limit for all others | A cloud flow that has no successful triggers will expire and be turned off; to keep the flow active you may need to adjust your trigger or purchase a standalone Power Automate license plan |
