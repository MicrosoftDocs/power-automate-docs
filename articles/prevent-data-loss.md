...
>[!IMPORTANT]
>
> - Enforcement of DLP policies is available for [Managed Environments](/power-platform/admin/managed-environment-overview) only. From January 2024, only desktop flows that are located in Managed Environments will be evaluated by DLP policies.
