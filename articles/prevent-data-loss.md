...
>[!IMPORTANT]
>
> - Enforcement of DLP policies is available for [Managed Environments](/power-platform/admin/managed-environment-overview) only. As of September 2023, only desktop flows that are located in Managed Environments are evaluated by DLP policies.
