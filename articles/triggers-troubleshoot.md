...
My flow is not listed - The Power Automate menu only lists flows that begin with the **When a row is added, modified or deleted** trigger and contain at least one trigger or action that references that entity. Flows that contain other types of triggers (automatic, scheduled, etc.) will not be listed in Dynamics 365. 
