...
> [!TIP]
> If you want to have your flows start automatically after you import a solution, use the Microsoft Dataverse (Current Environment) connector in your flow when you create it.
