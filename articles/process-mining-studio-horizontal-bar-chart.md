...
Select what each bar represents from the dropdown (for example, **Edges**, **Variants**, or **Attribute**).
...
Choose the type of metric to measure (for example, **Frequency**, **Performance**, **Finance**, or **Rework**).
...
Set the number of records to display. The default is 5.
