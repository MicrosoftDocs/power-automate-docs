...
7. Select **New step**, and then select **Add an action**.
8. Select **Dynamics 365 – Create a new row**.
...
11. A **Subject** box appears. When you select it, a dynamic content pane appears where you can select either of these columns.
    ...
    * **Topic**. If you select this column, the **Topic** column for the lead will be inserted in the **Subject** column of the task when it's created.
    ...
    > **Tip:** On the dynamic content pane, select **See more** to display more columns that are associated with the table. For example, you can also populate the **Subject** column of the task with the **Company Name**, **Customer**, **Description**, or **Email** column of the lead.
    > 
    > 
12. Select **Create flow**.
...
When you add a step to a cloud flow, you can select **Show advanced options** to add a filter or order by query that controls how the data is filtered in the flow.
...
2. On the actions toolbar, select **Pop Out**
   ![popout row.](./media/connection-dynamics365/popout.png) (or select **EMAIL A LINK** to copy the full URL to your default email program).
