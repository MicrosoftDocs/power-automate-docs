...
Certain characters, such as **&**, **#**, and **+** need to be replaced with its URL-encoded equivalent. Refer to [url encode special characters](/powerapps/developer/data-platform/webapi/query-data-web-api#url-encode-special-characters).
