...
1. As an owner, you can specify whether run-only users need to provide their own connections or you can use a connection that's already defined in the flow.
