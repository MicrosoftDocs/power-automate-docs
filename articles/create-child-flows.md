...
2. Presently, the parent flow and all child flows must be created within the same solution. Bringing an existing flow into a different solution to meet this pre-requisite has known issues, that will be resolved in a future release.
