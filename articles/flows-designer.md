...
The legend below the following screenshot describes the features of the cloud flows designer with copilot capabilities.
...
1. [**Send Feedback button:**](#send-feedback) Send us feedback on your flow creation experience, or general comments for the cloud flows designer with copilot capabilities.
...
1. [**Copilot button:**](get-started-with-copilot.md) Show or hide the **Copilot** pane. It appears by default when the cloud flows designer with copilot capabilities opens.
