...
1. Sign in to the [Power Automate](https://flow.microsoft.com), and then select on **My flows**.
...
1. Sign in to [Power Automate](https://flow.microsoft.com), and go to **Data** > **Connections**.
