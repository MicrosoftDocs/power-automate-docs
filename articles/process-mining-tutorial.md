...
- For the process mining tutorial, download the sample event log CSV file: [ProcessMiningSampleData.csv (English version)](https://go.microsoft.com/fwlink/?linkid=2181220) or [ProcessMiningSampleData.csv (French version)](https://go.microsoft.com/fwlink/?linkid=2181117). 
