...
Perhaps you found a template that is similar to what you are looking for, but isn't quite right for your scenario. No problem - just create your own flow from that template and tweak it to your liking. You can extend a flow created from a template by adding, editing, and removing triggers and actions. You can [copy paste actions](https://flow.microsoft.com/blog/introducing-clipboard-in-flow-designer-and-three-new-user-experience-updates/) in the same flow or across flows to speed up the process.

Did you not find a template you like? You can create a flow from scratch and connect the services you want to use. To learn more, go to [How to create a flow from scratch](/power-automate/get-started-logic-flow).  
