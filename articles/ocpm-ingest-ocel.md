...
To prepare the object-centric evenet log please follow the guidelines in [How to Create an Object‑Centric Event Log (OCEL)](), and store the resulting file in a CSV format in either Azure Data Lake Gen2 or OneLake.
...
4. Under the **Data source** heading, **Azure Data Lake** or **OneLake** and click **Continue**.
   ...
   ![Screenshot of the 'Create a new process' step.](/media/object-centric-process-mining/ocpm-create-process.png)

5. The subsequent steps on the **Connection setup** screen, differ for Azure Data Lake or OneLake, please follow the respective documentation until you reach the attribute mapping screen:
...
6. On the **Map your data** screen, map your data columns to appropriate attributes.
   ...
   * Event and Object level attributes (incl. financial) are optional but highly recommended for more detailed analysis
   ...
   ![Screenshot of the 'Map your data' step.](/media/object-centric-process-mining/ocpm-map-data.png)

7. Click **Save and Analyze**

8. After the ingestion is finished you should be navigated to the **Process Intelligence Studio for OCPM** with **Process overview** tab active.
   ...
   Learn more about [Process Intelligence Studio for OCPM - Process overview.]()
