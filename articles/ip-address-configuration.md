...
| gov.api.flow.microsoft.us | https | Access to several Power Platform APIs (U.S. Government - GCC only). |
...
| high.api.flow.microsoft.us | https | Access to several Power Platform APIs (U.S. Government - GCC High only). |
