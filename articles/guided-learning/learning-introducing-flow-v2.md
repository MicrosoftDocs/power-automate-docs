...
![Flow conceptual sketch](./media-v2/learning-introduce-flow/conceptual.png)
...
![List of services](./media-v2/learning-introduce-flow/services.png)
...
![Example of a notification mail or a push notification](./media-v2/learning-introduce-flow/sales-lead.png)
...
![List of files in Dropbox](./media-v2/learning-introduce-flow/dropbox-files.png) 

![List of same files in SharePoint](./media-v2/learning-introduce-flow/sharepoint-files.png) 
...
![List of tweets in Excel](./media-v2/learning-introduce-flow/tweets-to-excel.png)

![List of tweets in Excel](./media-v2/learning-introduce-flow/excel-tweets.png)

And finally, **you can automate approval loops** for, as an example, vacation requests in a SharePoint list.

![List of vacation requests in SharePoint](./media-v2/learning-introduce-flow/vacation-requests.png)
...
![List of templates](./media-v2/learning-introduce-flow/templates-you-might-use.png)
...
![Screen shot of mobile app](./media-v2/learning-introduce-flow/screen-mobile-app.png)  
...
![Start of tour](./media-v2/learning-introduce-flow/start-of-tour.png)
...
![What you can do](./media-v2/learning-introduce-flow/what-you-can-do.png)
...
![Template landing page](./media-v2/learning-introduce-flow/template-page.png)
